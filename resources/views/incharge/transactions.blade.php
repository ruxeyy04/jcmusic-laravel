...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
                            ...
                            <div class="xp-searchbar">
                                <form>
                                    <div class="input-group">
                                        <input type="search" class="form-control" placeholder="e.g. Flute">
            ...
            <!-- echo "<th> <b>Picture</b> </th>";
                                    echo "<th> <b>ID No.</b> </th>";
                                    echo "<th> <b>Name</b> </th>";
                                    echo "<th> <b>Brand</b> </th>";
                    ...
                    <div class="col-md-12">
                        <div class="table-wrapper">
                            ...
                            <div class='table-wrapper-scroll-y my-custom-scrollbar'>
                                <table class="table table-striped table-hover" id="transactionMod">
                                    <thead>
                                        <tr>
                                            <td>Order ID</td>
                                            <td>Date</td>
    ...
    <script src="/js/login/incharge.js"></script>
